...
class IndexController extends Controller{
    ...
    public function index($id = ''){
        //调试
        try{
            $appid = 'wx4ebb8c954a411d91'; //AppID(应用ID)
            $token = 'ysceettys'; //微信后台填写的TOKEN
            $crypt = 'FzoUqD1suf28BpDa4mjxQy08sTPleYXibx91R2lO9Zi'; //消息加密KEY（EncodingAESKey）
    ...
    private function demo($wechat, $data){
        switch ($data['MsgType']) {
            case Wechat::MSG_TYPE_EVENT:
                switch ($data['Event']) {
                    case Wechat::MSG_EVENT_SUBSCRIBE:
                        $wechat->replyText('欢迎您关注YS建筑公众平台！回复“文本”，“图片”，“语音”，“视频”，“音乐”，“图文”，“多图文”查看相应的信息！');
                        break;
                    ...
                    default:
                        $wechat->replyText("欢迎访问YS建筑公众平台！您的事件类型：{$data['Event']}，EventKey：{$data['EventKey']}");
                        break;
                }
                break;
            ...
            case Wechat::MSG_TYPE_TEXT:
                switch ($data['Content']) {
                    case '文本':
                        $wechat->replyText('欢迎访问YS建筑公众平台，这是文本回复的内容！');
                        break;
                    ...
                    case '图文':
                        $wechat->replyNewsOnce(
                            ...
                            "http://www.ysjianzhu.com/weixin/index.html",
                    ...
                    default:
                        $wechat->replyText("欢迎访问YS建筑公众平台！您输入的内容是：{$data['Content']}");
                        break;
                }
                break;
