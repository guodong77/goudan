...
let sco = {}
export default class PEditPost extends Component {
  constructor(props) {
    super(props); 
    main.init('PEditPost',this); 
    sco = this;
  }
    ...
    return (
         <Container>
              <Header style={{backgroundColor:'#5C9EFD'}}>
                    <Button transparent>
                        <Text onPress={() => {navigate('Pinfo', {name: 'Brent'})}} style={styles.PcomTitleText}>取消</Text>
                    </Button>

                    <Title style={[styles.PcomTitle,styles.PcomZiTitle]}>编辑职位</Title>
