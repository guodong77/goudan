      ...
      <Container>
        <Header style={[styles.gctopColor,styles.gctopheight]}>
          ...
          <Body style={styles.titleposition}>
            <Title style={styles.addToptitle}>公告详情</Title>
          </Body>
          <Right>
            <TouchableOpacity onPress={() => sco.ysnav.navigate('')}>
              <Text style={[styles.f16,styles.whiteText]}>发送</Text>
            </TouchableOpacity>
          </Right>
        </Header>
        <Content style={styles.whitebackground}>
          <List> 
              <ListItem style={styles.ListItemtype} first>
                ...
                <Input/>
                <TouchableOpacity onPress={() => sco.ysnav.navigate('Chooseperson')}>
