  ...
  render() {
    return (
      <Container>
        <HeadNav 
          headerText='企业关联'
          headerRight={<Image  source={require('../public/img/search.png')} />}
          fn={Actions.Findcompany}
        />
        {/* <Header style={[styles.gctopColor,styles.gctopheight,styles.worktimeRow,styles.xjuzhong]}>
          ...
          <Right>
            <TouchableOpacity onPress={Actions.Findcompany}>
            ...
            <View>
              ...
              <Card style={styles.relatecard}>
                <CardItem bordered>
                  ...
                  <TouchableOpacity onPress={Actions.Companydoclist}>
