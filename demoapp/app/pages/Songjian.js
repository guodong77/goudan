...
import { Container, Header, Content,Button,Item, Input,Text,Body,Left,Title,Right,Icon,Form,ScrollableTab,Card,CardItem,Tabs,Tab,Footer,Picker} from 'native-base';
    ...
    return (
      <Container>
        <HeadNav1
            ...
            Left={Actions.pop}
            headerText={
         <View style={[styles.posr,styles.titleposition,{justifyContent:'center',flex:5,}]}>
