...
export default class Buildlist extends Component {
  ...
  fn(){
    if(sco.state.showText){
         return (
    <View style={styles.Xiala}>
          <View style={styles.XialaTop}>
             <Text style={styles.XialaText}>2232</Text>
            </View>
...
//   {sco.state.showText==index&&
//     <View style={styles.Xiala}>
//        <View style={styles.XialaTop}>
//          <Text style={styles.XialaText}>{sco.fn()}</Text>
//        </View>
//        <Text style={styles.XialaText} onPress={Actions.Report}>举报</Text>
//    </View>
//  }
    ...
    <View style={styles.BuildPersonal}>
      <Image source={require('../public/img/Oval2.png')}/>
        ...
        <View style={styles.BuildPersonalXiala}>
            <TouchableOpacity style={[styles.BuildPersonalImg,{marginLeft:160}]}  onPress={()=>{if(ind1){
ind=index;
ind1=!ind1
            } else{
              ind=10000;
